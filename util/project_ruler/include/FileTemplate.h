...
private:
	...
	void	_addToMakefile(const std::string &entry, const std::string &type);
	static bool			_parseInterface(const std::string &s);
	static bool			_parseInheritance(const std::string &s);
	...
	static std::string		_nameClass(const std::string&);
