...
(*   Updated: 2015/06/24 18:06:03 by erobert          ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let () =
	...
	print_endline "----------";
	let r2 = new Dalek.dalek in
	let r3 = new Dalek.dalek in
	let r4 = new Dalek.dalek in
	let g0 = new Galifrey.galifrey ([r0; r1; r2; r3; r4]) ([d]) ([p; p; p; p]) in
	let g1 = new Galifrey.galifrey ([r0; r1; r2; r4]) ([d; d]) ([p; p; p; p]) in
	g0#do_time_war;
	print_endline "----------";
	g1#do_time_war
